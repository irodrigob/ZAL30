INTERFACE zif_al30_data
  ...
  TYPES: BEGIN OF ts_key_value,
           key   TYPE string,
           value TYPE string,
         END OF ts_key_value.
  TYPES tt_key_value TYPE STANDARD TABLE OF ts_key_value.

  TYPES: BEGIN OF ts_logon_lang,
           lang        TYPE sylangu,
           description TYPE string,
         END OF ts_logon_lang.
  TYPES: tt_logon_lang TYPE STANDARD TABLE OF ts_logon_lang.
  TYPES: tt_r_lang TYPE RANGE OF sylangu.
