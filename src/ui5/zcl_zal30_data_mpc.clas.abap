...
public section.
  ...
  types:
      begin of TS_READVIEW,
     TABNAME type TABNAME,
     FIELDNAME type FIELDNAME,
     POS_DDIC type /IWBEP/SB_ODATA_TY_INT2,
     MANDATORY type MANDATORY,
     NO_OUTPUT type LVC_NOOUT,
     CHECKBOX type LVC_CHECKB,
     SEL_SCREEN type FLAG,
     KEY_DDIC type KEYFLAG,
     ...
     EDIT type LVC_EDIT,
     TYPE type INTTYPE,
     LEN type /IWBEP/SB_ODATA_TY_INT2,
     DECIMALS type /IWBEP/SB_ODATA_TY_INT2,
     LOWERCASE type LOWERCASE,
     TECH type FLAG,
     DATATYPE type string,
  end of TS_READVIEW .
  types:
    TT_READVIEW type standard table of TS_READVIEW .
  types:
      begin of TS_READDATA,
     TABNAME type TABNAME,
     LANGU type LAISO,
     MODE type C length 1,
     DATA type string,
  ...
  types:
      begin of TS_LOCKVIEW,
     TABNAME type TABNAME,
     ALREADY_LOCKED type FLAG,
     LOCKBYUSER type string,
  end of TS_LOCKVIEW .
  types:
    TT_LOCKVIEW type standard table of TS_LOCKVIEW .
  types:
      begin of TS_ROWVALIDATIONDETERMINATION,
     LANGU type SPRAS,
     TABNAME type TABNAME,
     ROW type string,
  end of TS_ROWVALIDATIONDETERMINATION .
  types:
    TT_ROWVALIDATIONDETERMINATION type standard table of TS_ROWVALIDATIONDETERMINATION .
  types:
      begin of TS_VERIFYFIELDDATA,
     FIELDNAME type FIELDNAME,
     VALUE type string,
     LANGU type SPRAS,
     ...
     MESSAGE type string,
     TABNAME type TABNAME,
  end of TS_VERIFYFIELDDATA .
  types:
    TT_VERIFYFIELDDATA type standard table of TS_VERIFYFIELDDATA .
  types:
      begin of TS_SAVEDATA,
     LANGU type SPRAS,
     TABNAME type TABNAME,
     DATA type string,
     RETURN type string,
     ORIGINAL_DATA type string,
     TRANSPORT_ORDER type TRKORR,
  end of TS_SAVEDATA .
  types:
  ...
  types:
      begin of TS_CHECKTRANSPORTORDER,
     TRANSPORT_ORDER type TRKORR,
     LANGU type LANGU,
     MESSAGE type string,
  end of TS_CHECKTRANSPORTORDER .
  types:
  ...
  types:
      begin of TS_TRANSPORTDATA,
     LANGU type SPRAS,
     TABNAME type TABNAME,
     DATA type string,
     RETURN type string,
     TRANSPORT_ORDER type TRKORR,
  end of TS_TRANSPORTDATA .
  types:
    TT_TRANSPORTDATA type standard table of TS_TRANSPORTDATA .
  types:
      begin of TS_GETUSERCONF,
     USERNAME type string,
     DATE_FORMAT type string,
     DECIMAL_SEPARATOR type C length 1,
     THOUSAND_SEPARATOR type C length 1,
  end of TS_GETUSERCONF .
  types:
    TT_GETUSERCONF type standard table of TS_GETUSERCONF .
  ...
  constants GC_GETUSERCONF type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'getUserConf' ##NO_TEXT.
  ...
  constants GC_TRANSPORTDATA type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'transportData' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_CHECKAUTHVIEW
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_READVIEW
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_READDATA
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_LOCKVIEW
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ROWVALIDATIONDETERMINAT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_VERIFYFIELDDATA
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  ...
  methods DEFINE_GETSEARCHHELPDATA
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_TRANSPORTDATA
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_GETUSERCONF
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_CHECKTRANSPORTORDER.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - checkTransportOrder
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'checkTransportOrder' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'TRANSPORTORDER' iv_abap_fieldname = 'TRANSPORT_ORDER' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZAL30_DATA_MPC=>TS_CHECKTRANSPORTORDER' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'checkTransportOrderSet' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LABELFIELDCODE' iv_abap_fieldname = 'LABEL_FIELD_CODE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LABELFIELDDESCRIPTION' iv_abap_fieldname = 'LABEL_FIELD_DESCRIPTION' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'getUserConf' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DATEFORMAT' iv_abap_fieldname = 'DATE_FORMAT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DECIMALSEPARATOR' iv_abap_fieldname = 'DECIMAL_SEPARATOR' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'THOUSANDSEPARATOR' iv_abap_fieldname = 'THOUSAND_SEPARATOR' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 1 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZAL30_DATA_MPC=>TS_GETUSERCONF' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'getUserConfSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'lockView' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'VIEWNAME' iv_abap_fieldname = 'TABNAME' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ALREADYLOCKED' iv_abap_fieldname = 'ALREADY_LOCKED' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LOCKBYUSER' iv_abap_fieldname = 'LOCKBYUSER' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZAL30_DATA_MPC=>TS_LOCKVIEW' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'lockViewSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'readData' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'MODE' iv_abap_fieldname = 'MODE' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 1 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'readDataSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'readView' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'POSITION' iv_abap_fieldname = 'POS_DDIC' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'NOOUTPUT' iv_abap_fieldname = 'NO_OUTPUT' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CHECKBOX' iv_abap_fieldname = 'CHECKBOX' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SELSCREEN' iv_abap_fieldname = 'SEL_SCREEN' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'KEYDDIC' iv_abap_fieldname = 'KEY_DDIC' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FIELDTEXTTABLE' iv_abap_fieldname = 'FIELD_TEXTTABLE' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LANGTEXTTABLE' iv_abap_fieldname = 'LANG_TEXTTABLE' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'EDIT' iv_abap_fieldname = 'EDIT' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LEN' iv_abap_fieldname = 'LEN' ). "#EC NOTEXT
lo_property->set_type_edm_int16( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DECIMALS' iv_abap_fieldname = 'DECIMALS' ). "#EC NOTEXT
lo_property->set_type_edm_int16( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LOWERCASE' iv_abap_fieldname = 'LOWERCASE' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TECH' iv_abap_fieldname = 'TECH' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZAL30_DATA_MPC=>TS_READVIEW' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'readViewSet' ). "#EC NOTEXT
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_ROWVALIDATIONDETERMINAT.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - rowValidationDetermination
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'rowValidationDetermination' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZAL30_DATA_MPC=>TS_ROWVALIDATIONDETERMINATION' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'rowValidationDeterminationSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'saveData' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'saveDataSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'transportData' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZAL30_DATA_MPC=>TS_TRANSPORTDATA' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'transportDataSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - verifyFieldData
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'verifyFieldData' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'COLUMN' iv_abap_fieldname = 'FIELDNAME' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'MESSAGE_TYPE' iv_abap_fieldname = 'MESSAGE_TYPE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 1 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZAL30_DATA_MPC=>TS_VERIFYFIELDDATA' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'verifyFieldDataSet' ). "#EC NOTEXT
